/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93eb9b1c2e0520711d906791b50286e7)
// Runtime types generated with workerd@1.20260210.0 2026-01-29 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./app/entry.rsc");
		durableNamespaces: "MyDurableObject";
	}
	interface Env {
		DISCORD_URL: "https://discord.com/invite/cloudflaredev";
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./app/entry.rsc").MyDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_URL">> {}
}
